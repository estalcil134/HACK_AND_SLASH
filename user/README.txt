...
The logo for the user, the user's nav bar, and the footer for the page are loaded in from using PHP require statements and the main content for the non-admin user homepage are the three options: Tutorials, Challenges, and Scoreboard. The three images are linked to the correct locations and clickable.
